...
export const useGetBooks = <TError = ErrorResponse>(
 params?: GetBooksParams, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getBooks>>, TError> & { swrKey?: Key, enabled?: boolean },  }
...
export const useGetBook = <TError = ErrorResponse>(
 id: number, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getBook>>, TError> & { swrKey?: Key, enabled?: boolean },  }
